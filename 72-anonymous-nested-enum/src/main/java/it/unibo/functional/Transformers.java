...
public final class Transformers {
    ...
    public static <I, O> List<O> transform(final Iterable<I> base, final Function<I, O> transformer) {
        final Function<I, Collection<O>> transformFunction = new Function<>() {
        ...
        return flattenTransform(base, transformFunction);
    }
    ...
    public static <I> List<I> select(final Iterable<I> base, final Function<I, Boolean> test) {
        ...
        final Function<I, Collection<I>> rejectFuncion = new Function<>() {
        ...
        return flattenTransform(base, rejectFuncion);
    }
